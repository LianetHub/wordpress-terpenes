...
import { js, uiJs, copyJsLibs, jsChunks } from "./gulp/tasks/js.js";
...
function watcher() {
    ...
    gulp.watch(path.watch.js, gulp.parallel(js, uiJs));
...
const mainTasks = gulp.series(
    fonts,
    gulp.parallel(copy, normalize, scss, copyCssLibs, favicon, js, uiJs, copyJsLibs, jsChunks, json, images)
);
