                        ...
                        <?php if ($image_item_class): ?>
                            <svg class="svg">
                                ...
                                <? if (esc_attr($image_item_class) === 'mask-4'): ?>
                                    <clipPath id="desk-mask-4" clipPathUnits="objectBoundingBox">
                                ...
                                <?php endif; ?>
                                <? if (esc_attr($image_item_class) === 'mask-5'): ?>
                                    <clipPath id="desk-mask-5" clipPathUnits="objectBoundingBox">
                                        <path d="M0.506,0.011 C0.635,0.029,0.73,0.117,0.82,0.206 C0.905,0.29,0.983,0.381,0.996,0.496 C1,0.624,0.99,0.762,0.894,0.855 C0.797,0.951,0.647,0.963,0.506,0.976 C0.343,0.99,0.14,1,0.037,0.929 C-0.066,0.812,0.077,0.647,0.085,0.496 C0.093,0.361,-0.01,0.211,0.082,0.105 C0.176,-0.004,0.356,-0.009,0.506,0.011"></path>
                                    </clipPath>
                                <?php endif; ?>
                            </svg>
                        <?php endif; ?>
